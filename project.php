			...
			<div class="container">
				<ul class="nav nav-tabs nav-justified" role="tablist">
					...
					<li><a href="endorsements.html">
						<span class="glyphicon glyphicon-heart"></span>Endorsements</a>
						</li>
			  	...
			  	<div id="myCarousel" class="carousel slide" data-ride="carousel">
    				...
    				<div class="carousel-inner">
      					<div class="item active">
        					<img src="cello.jpg" alt="Cello" style="width:100%;">
      					</div>

      					<div class="item">
        					<img src="popsicles.jpg" alt="Popsicles" style="width:100%;">
      					</div>
    
      					<div class="item">
        					<img src="sunshine.jpg" alt="Sunshine" style="width:100%;">
      					</div>
    				</div>
